...
|   | 1byte  | 1byte  | 1byte  | 1byte |Additionnal info|
|---|--------|--------|--------|-------|-|
...
045 | JMPB   | OFFSET | EMPTY  | EMPTY | Inserted automatically by the assembler |
046 | JMPW   | OFFSET | OFFSET | EMPTY | Inserted automatically by the assembler |
047 | JMPT   | OFFSET | OFFSET | OFFSET | Inserted automatically by the assembler |
048 | CALL   | OFFSET | OFFSET | OFFSET ||
049 | CALLB  | OFFSET | EMPTY  | EMPTY | Inserted automatically by the assembler |
050 | CALLW  | OFFSET | OFFSET | EMPTY | Inserted automatically by the assembler |
051 | CALLT  | OFFSET | OFFSET | OFFSET | Inserted automatically by the assembler |
